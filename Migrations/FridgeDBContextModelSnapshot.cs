            ...
            modelBuilder.Entity("FutureFridges.Business.Admin.Settings", b =>
                {
                    ...
                    b.Property<bool>("NotifyAllHeadChefs")
                        .HasColumnType("bit");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UID = new Guid("89aea9fd-a242-455a-87ec-6b12c568453b")
                        });
                });
            ...
            modelBuilder.Entity("FutureFridges.Business.AuditLog.LogEntry", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EventTime = new DateTime(2023, 2, 9, 14, 52, 3, 89, DateTimeKind.Local).AddTicks(3508),
                            LogType = 1,
                            UID = new Guid("6f692169-c649-4a0a-b70f-f38c8a9dca73"),
            ...
            modelBuilder.Entity("FutureFridges.Business.OrderManagement.OrderItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Quantity = 3,
                            SupplierUID = new Guid("a27ccab3-cdf9-4888-a2fa-d16a3462ad9a"),
                            UID = new Guid("13d17b23-778b-4c41-ab11-6bace3502274")
                        });
                });
            ...
            modelBuilder.Entity("FutureFridges.Business.StockManagement.StockItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ExpiryDate = new DateTime(2023, 2, 9, 14, 52, 3, 89, DateTimeKind.Local).AddTicks(3394),
            ...
            modelBuilder.Entity("FutureFridges.Business.UserManagement.FridgeUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "afa1d5d6-0120-4854-afe5-61a197a951cd",
                            Email = "admin@fridges.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@FRIDGES.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAEAACcQAAAAEKWR4cRiArRJOJAiOJ9+V7lR5PgspHXlrtSIA+5FsaXPI1Bimvm8Ifg4x6OMK2dEKw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a393609c-cc85-44c4-a4de-99dd14c7ce36",
